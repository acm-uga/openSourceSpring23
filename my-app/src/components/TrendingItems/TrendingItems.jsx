    ...
    <div id="trending-items">
      ...
      <div className="trending-items-grid">
        <Card
          style={{
            backgroundImage:
              'url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRX6Srw0WC0k6FwQwIj6xGofodscu8McMae-OblDlMQzxlnEoA-SwjuPea6U-BmEfGDkRg&usqp=CAU)',
          }}>
        ...
        <Card
          style={{
            backgroundImage:
              'url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSNHvGcSqn4rs8Lciw4ZiBTJCNPB8Rmj6cEg9cPKD8_CVmKkLfpR2SYLku0mMBAPvB92I4&usqp=CAU)',
          }}>
        ...
        <Card
          style={{
            backgroundImage:
              'url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTmfxxzaqGxdDrMjb4KVp9mkZDpj03zpwWgpg&usqp=CAU)',
          }}>
        ...
        <Card
          style={{
            backgroundImage:
              'url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOPFJmsRK0ErT6B63G18DRNy128bQPQQhH1XQhX-rJ3c98SbYPUYSuwCVx_xzLuyvBBwU&usqp=CAU)',
          }}>
        ...
        <Card
          style={{
            backgroundImage:
              'url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQN3lanUqUzzVotPTsv4mck0j6VkxSXi3HFjw&usqp=CAU)',
          }}>
        ...
        <Card
          style={{
            backgroundImage:
              'url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQnR7UE8X_iaHRBvS237N6DKIeJP6nN_G5pJA&usqp=CAU)',
          }}>
